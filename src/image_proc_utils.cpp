 ...
 */
void ImageProcUtils::detectFloorFromPointCloud(short* xyz_frame, float floor_distance_threshold_mm, int image_width,
                                               int image_height, unsigned short* output_depth_frame,
                                               short* output_xyz_frame, FilterFlag filter_flag,
